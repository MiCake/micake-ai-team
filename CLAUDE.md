...
> `analyze` | `analyze-code` | `design` | `implement` | `fix` | `refactor` | `frontend-doc` | `review` | `test` | `init` | `status` | `config` | `sync-context` | `update-framework` | `cleanup`
...
| `#implement`, `#fix`, `#refactor`, `#frontend-doc` | Developer | `.ai-agents/agents/developer.md` |
...
|---------|-------|---------|
| `#init` | Conductor | Initialize project |
| `#analyze` | Analyst | Analyze requirements |
